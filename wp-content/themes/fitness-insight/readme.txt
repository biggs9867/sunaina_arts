...
= 0.3 =
    -- Changed tags.
    -- Deleted unused files and folder.
...
= 0.3.6 =
	-- Added scroll top alignment setting.
	-- Updated PHP version.
...
= 0.3.8 =
	-- Added Shop & Product page settings.

= 0.3.9 =
	-- Updated sections customizer settings.
	-- Updated PHP version.

= 0.4 =
	-- Solve bug fixes.
	-- Added button CSS in get-started.
